...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_ordered', models.DateTimeField(default=datetime.datetime(2025, 8, 21, 12, 2, 32, 644792))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('production_price', models.FloatField(blank=True, null=True)),
                ('retail_price', models.FloatField(null=True)),
                ('category', models.CharField(choices=[('', 'Select a category..'), ('S', 'Skin Cosmetics'), ('F', 'Face Makeup'), ('N', 'Nail Cosmetics'), ('H', 'Hair Cosmetics'), ('O', 'Other Categories')], max_length=1, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team_member', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='EmployeeManagement.employees')),
            ],
        ),
        migrations.CreateModel(
            name='SalesTask',
            fields=[
                ...
                ('sales_team', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='CustomerAndSalesManagement.salesteam')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(max_length=200, null=True)),
                ('province', models.CharField(choices=[('', 'Select a Province'), ('Western Province', 'Western Province'), ('Southern Province', 'Southern Province'), ('Eastern Province', 'Eastern Province'), ('Central Province', 'Central Province'), ('Northcentral Province', 'Northcentral Province'), ('Northern Province', 'Northern Province'), ('Northwest Province', 'Northwest Province'), ('Uwa Province', 'Uwa Province')], max_length=200, null=True)),
                ('zip_code', models.IntegerField(null=True)),
                ('date_ordered', models.DateTimeField(auto_now_add=True)),
                ('request_status', models.CharField(default='Request Pending', max_length=20)),
